...
use pcie::GenericPcieRootPortDefinition;
        ...
        let mut pcie_host_bridges = Vec::new();
        {
            ...
            for rc in cfg.pcie_root_complexes {
                ...
                let host_bridge = PcieHostBridge {
                    ...
                    high_mmio: MemoryRange::new(high_mmio_address..high_mmio_address+rc.high_mmio_size),
                };
                ...
                let root_complex = chipset_builder
                    ...
                    .add(|services| {
                        let root_port_definitions = rc.ports.into_iter()
